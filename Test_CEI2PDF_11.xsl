    ...
    <xsl:template name="charter">
        ...
        <fo:root>
            ...
            <fo:layout-master-set>
                ...
                <!-- Register -->
                <fo:simple-page-master master-name="rechts_2" margin-top="2cm" margin-bottom="2cm"
                    margin-left="2cm" margin-right="2cm">
                ...
                <fo:simple-page-master master-name="links_2" margin-top="2cm" margin-bottom="2cm"
                    margin-left="2cm" margin-right="2cm">
                    <fo:region-body margin-top="10mm" column-count="2" column-gap="7mm"/>
                    <fo:region-before extent="20mm" region-name="kopf-linke-seiten"/>
                    <fo:region-after/>
                ...
                <fo:static-content flow-name="kopf-rechte-seiten">
                    <fo:table table-layout="fixed" width="100%">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell column-number="2">
                                    <fo:block text-align="center">Indice</fo:block>
                                </fo:table-cell>
                                <fo:table-cell column-number="3">
                                    <fo:block text-align="right">
                                        <fo:page-number/>
